"""Module providing  DreamWalk model implementation."""

from typing import Optional, Dict, Any
from embiggen.embedders.ensmallen_embedders.node2vec import Node2VecEnsmallen


class Node2VecDreamwalkEnsmallen(Node2VecEnsmallen):
    """Class providing Node2Vec Dreamwalk implemeted in Rust from Ensmallen."""
